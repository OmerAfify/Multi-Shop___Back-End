...
namespace OnlineShopWebAPIs.Migrations
{
    ...
    [Migration("20230326183229_OrdersTablesAreCreated")]
    partial class OrdersTablesAreCreated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.OrderDeliveryMethods", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Models.OrderedItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Models.Order", b =>
                {
                    b.HasOne("Models.OrderDeliveryMethods", "DeliveryMethod")
                        .WithMany()
                    ...
                    b.OwnsOne("Models.OrderAddress", "ShippingAddress", b1 =>
                        {
            ...
            modelBuilder.Entity("Models.OrderedItem", b =>
                {
                    ...
                    b.OwnsOne("Models.ProductItemOrdered", "ProductItemOrdered", b1 =>
                        {
